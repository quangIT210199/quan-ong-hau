...
public class Contrants {
    ...
    public static final String USER_VERIFY_CONTENT="Dear [[name]],<br>Please click the link below to verify your registration:<br><h3><a href=\"[[URL]]\" target=\"_self\">VERIFY</a></h3>Thank you,<br>Coderlover.";
}
