    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    ...
                    .antMatchers("/api/products/**").permitAll() // hasRole("ADMIN")
                    .antMatchers("/api/categories/**").permitAll() // hasRole("ADMIN")
                    .antMatchers("/api/brand/**").permitAll()
                    .antMatchers("/api/users/**").permitAll() // hasRole("ADMIN")
                    .antMatchers("/api/carts/**").permitAll() // hasAnyRole("USER", "ADMIN")
                    .antMatchers("/api/bills/**").permitAll() // hasRole("ADMIN")
